#include <stdio.h>
#include <string.h>
*/// 키워드셜명 변수는 무엇인가4개/ 배열관련 문제 많은 o/x문제 10개 2점짜리,재귀함수 1문제, 전체 문제 총 10문제 코드작성 4문제 재귀함수코드 푸는 문제하나 포인터에서 수합하는거 포인터에서 변경이안됀다 9강 포인터 니드 swap관련됀거 하나 키오스크문제1개(반복한거 어려운거는 아님)
// 메뉴표 생성(전역)
...
int main() {
    while(1) {
        ...
        if(menu_num == 1) {          // 햄버거 세트
            empty_idx = empty_order_search();  // 빈칸 찾기
